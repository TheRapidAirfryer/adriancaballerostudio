...
export const projects: Project[] = [
  ...
  },
  {
    ...
    categories: ["web"],
    services: ["desarrollo-web"],
    year: "[EDITAR: año del proyecto]",
    isPlaceholder: true,
    summary: "Diseño y desarrollo de un sitio web para Ciudad Pinares, un proyecto residencial.",
    objective: "[EDITAR: objetivo — ej. presentar el proyecto residencial y generar contactos de interesados].",
    challenge: "[EDITAR: reto particular del proyecto].",
  ...
  },
  {
    ...
    year: "2026",
    isPlaceholder: true,
    summary: "Manejo de redes sociales y creación de contenido (video y diseño gráfico) para Bodega Marisol, además de la gestión de sus campañas publicitarias en Meta.",
