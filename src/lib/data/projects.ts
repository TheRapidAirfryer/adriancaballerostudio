...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2025",
    isPlaceholder: true,
    summary: "Diseño y desarrollo de un sitio multipágina para reemplazar un sitio anterior lento y sin posicionamiento.",
    objective: "[EDITAR: objetivo — ej. aumentar leads orgánicos y mejorar velocidad de carga].",
    challenge: "[EDITAR: descripción del reto — ej. sitio anterior no posicionaba, tiempos de carga altos].",
    ...
    seoTitle: "Sitio web corporativo optimizado para SEO | Portafolio Adrian Caballero Studio",
    seoDescription: "Caso de estudio: diseño y desarrollo de un sitio web corporativo multipágina optimizado para SEO y velocidad.",
  },
  {
